...
// var NewApiRootUrl = 'https://yxgj.91ygxc.com/api/';
var config = require('./config.js');
var NewApiRootUrl = config.NewApiRootUrlObj[config.env];
...
module.exports = {
  ...
  IndexUrlHotGoods: NewApiRootUrl + 'index/hotGoods', //首页人气推荐数据接口
  IndexUrlTopic: NewApiRootUrl + 'index/topic', //首页专题精选数据接口
  IndexUrlBrand: NewApiRootUrl + 'index/brand', //首页数据接口IndexUrlChannel
  IndexUrlCategory: NewApiRootUrl + 'index/category', //首页分类数据接口IndexUrlChannel
  IndexUrlBanner: NewApiRootUrl + 'index/banner', //首页轮播图数据接口IndexUrlChannel
