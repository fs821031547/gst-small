...
Page({
    ...
    onShareAppMessage: function() {
        ...
        return {
            ...
            path: 'pages/goods/goods?id=' + this.data.id + '&type=' + this.data.type + '&userId=' + wx.getStorageSync('uId'),
        }
    },
    ...
    getCouponList: function() {
        ...
        }, "POST", "application/json", true).then(function(res) {
            if (res.errno === 0) {
                that.setData({
                    merCoupon: res.data,
                });
    ...
    getGoodsInfo: function() {
        ...
        util.request(api.GoodsDetail, {
            ...
            if (res.errno === 0) {
              ...
              res.data.info.goods_desc = res.data.info.goods_desc.replace(/&quot/g," ");
    ...
    cartGoodsCount: function() {
      ...
      }, "GET", "application/json", true).then(function(res) {
            if (res.errno === 0) {
                that.setData({
    ...
    buyGoods: function(e) {
        var that = this;
      var ntype = e.currentTarget.dataset.ntype || ''
      var activityType = e.currentTarget.dataset.activitytype || '';
      var groupBuyingId = e.currentTarget.dataset.groupbuyingid || '';
        that.setData({
